...
- Legal barriers, *copyright* ([[http://web.stanford.edu/~vcs/talks/SC15-Nov182015-STODDEN.pdf][many ongoing thoughts on this in the US]])
...
*** Next steps
_ Examples of reproducible articles with Org-mode:
...
- Series of webinars on Reproducible Research: [[https://github.com/alegrand/RR_webinars]]
